...
Exercício 1)
    ...
    A taxa de aprendizagem mostrou-se necessitar ser extremamente baixa, apresentando alta sensibilidade a sutis variações, dado que a reta estimada inicial já era bem adaptada ao dataset, o que fazia com que um aprendizado muito grande prejudicasse muito uma solução já bastante boa, necessitando de muitas iterações para chegar a uma convergência.
    Após uma quantidade extensiva de testes, observou-se que o alpha produz resultados palpáveis somente por volta de 0.01, onde o número específico 0.011 apresentou o menor erro quadrático médio.
    Nesse contexto, obteve-se um erro quadrático médio aproximado de 6.476 com 1000 iterações, mudando apenas a quarta casa decimal em diante ao aumentar mais a quantidade de iterações, sendo desnecessário para a precisão almejada com este exercício.
